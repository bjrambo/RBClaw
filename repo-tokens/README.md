...
```yaml
- uses: bjrambo/RBClaw/repo-tokens@v1
  with:
    include: 'src/**/*.ts'
    exclude: 'src/**/*.test.ts'
```
...
| Repo | Badge |
|------|-------|
| [RBClaw](https://github.com/bjrambo/RBClaw) | ![tokens](https://raw.githubusercontent.com/bjrambo/RBClaw/main/repo-tokens/badge.svg) |
