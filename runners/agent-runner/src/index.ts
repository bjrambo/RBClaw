 ...
 *   IPC:   Follow-up messages written as JSON files to $RBCLAW_IPC_DIR/input/
...
const GROUP_DIR = process.env[RBCLAW_ENV.groupDir] || '/workspace/group';
const IPC_DIR = process.env[RBCLAW_ENV.ipcDir] || '/workspace/ipc';
const HOST_IPC_DIR = process.env[RBCLAW_ENV.hostIpcDir] || IPC_DIR;
// Optional: override cwd (agent works in this directory instead of GROUP_DIR)
const WORK_DIR = process.env[RBCLAW_ENV.workDir] || '';
const GROUP_FOLDER = process.env[RBCLAW_ENV.groupFolder] || '';
