...
export function registerRepoEvidenceTool(
  ...
  server.tool(
    'read_repo_evidence',
    'Read fixed git evidence directly from RBCLAW_WORK_DIR without broad shell access. Use this when reviewer/arbiter needs current branch, dirty state, recent commits, or a specific commit/ref.',
    {
      action: z
