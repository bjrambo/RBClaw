...
export const REVIEWER_RUNTIME_ENV = 'RBCLAW_REVIEWER_RUNTIME';
export const ARBITER_RUNTIME_ENV = 'RBCLAW_ARBITER_RUNTIME';
export const UNSAFE_HOST_PAIRED_MODE_ENV = 'RBCLAW_UNSAFE_HOST_PAIRED_MODE';
export const CLAUDE_REVIEWER_READONLY_ENV = 'RBCLAW_CLAUDE_REVIEWER_READONLY';
