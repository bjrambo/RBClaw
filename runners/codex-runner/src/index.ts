 ...
 *   IPC:   Follow-up messages as JSON files in $RBCLAW_IPC_DIR/input/
...
if (!WORK_DIR) {
  throw new Error('Channel workDir is required for Codex execution.');
}
const EFFECTIVE_CWD = WORK_DIR;
