...
import {
  ...
  repairMissingMainRoomWorkDirsInDatabase,
...
export function repairMissingMainRoomWorkDirs(workDir: string): number {
  return repairMissingMainRoomWorkDirsInDatabase(requireDatabase(), workDir);
}
