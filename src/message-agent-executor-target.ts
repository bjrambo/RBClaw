...
import { isUnsafeHostPairedModeEnabled } from 'rbclaw-runners-shared';
...
class MessageAgentExecutionTargetPreparer {
  ...
  private async resolveMemoryBriefing(): Promise<string | undefined> {
  ...
  private applyRuntimePairedTurnEnvOverrides(args: {
    ...
    args.pairedExecutionContext.envOverrides.RBCLAW_PAIRED_TURN_ID =
      args.runtimePairedTurnIdentity.turnId;
    args.pairedExecutionContext.envOverrides.RBCLAW_PAIRED_TURN_ROLE =
      args.runtimePairedTurnIdentity.role;
    args.pairedExecutionContext.envOverrides.RBCLAW_PAIRED_TURN_INTENT =
      args.runtimePairedTurnIdentity.intentKind;
    args.pairedExecutionContext.envOverrides.RBCLAW_PAIRED_TASK_UPDATED_AT =
      args.runtimePairedTurnIdentity.taskUpdatedAt;
  }
