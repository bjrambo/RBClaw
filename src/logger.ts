...
type LoggerGlobalState = typeof globalThis & {
  __rbclawLogger?: Logger;
  __rbclawProcessHandlersInstalled?: boolean;
};
...
export const logger =
  globalState.__rbclawLogger ??
  (globalState.__rbclawLogger = createRootLogger());
...
if (!globalState.__rbclawProcessHandlersInstalled) {
  process.on('uncaughtException', handleUncaughtException);
  process.on('unhandledRejection', handleUnhandledRejection);
  globalState.__rbclawProcessHandlersInstalled = true;
}
