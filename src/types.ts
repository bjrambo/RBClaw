...
export const VOICE_COMPANION_APPROVAL_LEVELS = [
  'none',
  'confirmed',
  'high_risk_confirmed',
] as const;
export type VoiceCompanionApprovalLevel =
  (typeof VOICE_COMPANION_APPROVAL_LEVELS)[number];

export const VOICE_COMPANION_APPROVAL_METHODS = [
  'button',
  'typed_pin',
  'local_confirm_click',
  'physical_hotkey',
] as const;
export type VoiceCompanionApprovalMethod =
  (typeof VOICE_COMPANION_APPROVAL_METHODS)[number];
