# RBClaw Codebase Simplification & Quality Improvement Spec
...
**Superseded note (2026-07-16):** The paired workspace lifecycle was removed. Paired roles now use the channel's configured direct work directory, so workspace-manager recommendations below no longer apply.
