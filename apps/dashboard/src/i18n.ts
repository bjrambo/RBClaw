...
export interface Messages {
  ...
  settings: {
    ...
    dashboardTokenPlaceholder: string;
    dashboardTokenHelp: string;
    navAria: string;
    contentAria: string;
    sidebarAria: string;
    nav: {
...
export const messages = {
  ko: {
    ...
    settings: {
      ...
      languageLabel: '언어',
      dashboardTokenLabel: 'Dashboard token',
      dashboardTokenPlaceholder: 'WEB_DASHBOARD_TOKEN',
      dashboardTokenHelp:
        '채팅 보내기, 설정 저장, 재시작 같은 변경 요청에만 브라우저에서 첨부됩니다.',
      navAria: '설정 섹션',
      contentAria: '설정 항목',
  ...
  en: {
    ...
    settings: {
      ...
      dashboardTokenPlaceholder: 'WEB_DASHBOARD_TOKEN',
      dashboardTokenHelp:
        'Stored in this browser and attached only to mutating dashboard requests.',
  ...
  ja: {
    ...
    settings: {
      ...
      dashboardTokenPlaceholder: 'WEB_DASHBOARD_TOKEN',
      dashboardTokenHelp:
        'このブラウザに保存し、変更を伴うダッシュボード要求にだけ付与します。',
      navAria: '設定セクション',
      contentAria: '設定項目',
      sidebarAria: '設定ナビと適用',
      nav: {
