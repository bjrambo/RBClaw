...
export function GeneralSettings({
  ...
  locale: Locale;
  nickname: string;
  onDashboardTokenChange: (next: string) => void;
        ...
        <div className="settings-form-grid">
          ...
          <label className="settings-row">
            <span className="settings-label">
              {t.settings.dashboardTokenLabel}
            </span>
            <input
              autoComplete="off"
              onChange={(event) => onDashboardTokenChange(event.target.value)}
              placeholder={t.settings.dashboardTokenPlaceholder}
              spellCheck={false}
              type="password"
              value={dashboardToken}
            />
            <small className="settings-hint">
              {t.settings.dashboardTokenHelp}
            </small>
          </label>
        </div>
      </div>
