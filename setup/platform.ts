/**
 * Cross-platform detection utilities for RBClaw setup.
 */
...
export function ensureLinuxReadonlySandboxAppArmorSupport(options?: {
  ...
  const sysctlPath = '/etc/sysctl.d/90-rbclaw-sandbox.conf';
  const sysctlContents =
    '# Managed by RBClaw setup to allow bubblewrap readonly sandboxing.\n' +
